...
import com.andymarcial.psicotecnicostropa.tropa.main_calculabaremo;
...
public class main_resultado_exam_academia extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notas = main_examen_academia.notas;
            ...
            public void onClick(View v) {
                if (baremo.getText().toString().equals("")) {
                    ...
                    if (kk > 0 && kk < 41) {
                        ...
                        intentCompartir.putExtra(Intent.EXTRA_STREAM, Uri.parse("android.resource://com.andymarcial.psicotecnicostropa/drawable/ic_launcher"));
        ...
        introbar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(main_resultado_exam_academia.this, main_calculabaremo.class));
                        ...
                        if (notas.getNotaredondeadabar() != 0) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    main_examen_academia.guardado = true;
        ...
        if (main_examen_academia.acabar == true) {
            guardar.setEnabled(true);
            if (main_examen_academia.guardado == true) {
                guardar.setEnabled(false);
            } else {
                guardar.setEnabled(true);
            }
